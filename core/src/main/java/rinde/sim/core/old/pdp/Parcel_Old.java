 ...
 */
public abstract class Parcel_Old extends PDPObjectImpl {
     ...
     */
    public Parcel_Old(Point pDestination, long pPickupDuration,
    ...
    public boolean canBePickedUp(Vehicle_Old v, long time) {
        return true;
    }

    public boolean canBeDelivered(Vehicle_Old v, long time) {
        return true;
    }
