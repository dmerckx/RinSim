package rinde.sim.core.simulation.policies.agents.areas;
...
public class Areas extends AgentsPolicyAbstr{
    ...
    public Areas(int batchSize, int nrRegions, int threadsPerRegio) {
    ...
    public void doTicks(TimeInterval interval) {
        ...
        while(it.hasNext()){
            ...
            Point pos = ((RoadUser<?>) entry.getKey()).getRoadState().getLocation();
        ...
        //System.out.println("Now deblock all theads one by one"); 
